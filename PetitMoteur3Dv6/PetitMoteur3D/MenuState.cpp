...
MenuState::MenuState(StateStack& stack, Context context)
	...
	, title{ SpriteManager::GetInstance().GetFontTitle(), 215, 50, 600, 200, context.pDispositif }
	, textEnter{ SpriteManager::GetInstance().GetFontTitle(), 215, 570, 630, 200, context.pDispositif }
{
